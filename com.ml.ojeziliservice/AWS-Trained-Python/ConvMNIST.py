...
print(sess.run(correct_prediction, feed_dict={x:mnist.test.images[0:1][:]}))
...
signature = tf.saved_model.signature_def_utils.build_signature_def(
    ...
    outputs = {'output': tf.saved_model.utils.build_tensor_info(y_)},
  )

saved_model_builder = tf.saved_model.builder
mb = saved_model_builder.SavedModelBuilder('/tmp/convmodel1')
